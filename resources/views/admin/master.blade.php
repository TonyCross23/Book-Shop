    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('admin@allPost') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin@categoryList') }}">Category List</a>
                        <a class="collapse-item" href="{{ route('admin@categoryCreatePage') }}">Create Category</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin@postList') }}">Post List</a>
                        <a class="collapse-item" href="{{ route('admin@postIndex') }}">Post Create</a>
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @else
                                    <img src="{{ asset('storage/' . Auth::user()->image) }}"
                                        class="img-profile rounded-circle me-1" width="100%" height="30px" />
                                @endif
