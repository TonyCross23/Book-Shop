    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-3 offset-6">
                ...
                <form action="" method="get">
                    @csrf
                    <div class="d-flex">
                        <input type="text" name="key" class="form-control mr-2" placeholder="Search"
                            value="{{ request('key') }}">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin@categoryCreatePage') }}" class="badge bg-success mb-3" title="Create Category"><i
                        ...
                        <tbody>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ route('admin@editPage', $item->id) }}"
                                                    class="btn btn-primary text-white btn-sm me-1"><i
                            ...
                            @else
                                ...
                                <td class="text-center"><span
                                        class="bg-danger text-white fs-3 rounded px-3 text-center">Empty Category!</span>
                                </td>
                                <td></td>
                            @endif
                        </tbody>
